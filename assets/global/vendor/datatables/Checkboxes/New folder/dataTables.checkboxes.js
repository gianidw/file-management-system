...
/* eslint-enable */
   ...
   */
   Checkboxes.defaults = {
      ...
      */
      selectAllRender: '<div class="checkbox-custom checkbox-primary"><input type="checkbox" autocomplete="off" id="DTListChxBxAll" name="DTListChxBxAll"><label for="DTListChxBxAll"></label></div>'
   };
