    ...
    babelHelpers.createClass(Site, [{
      ...
      value: function startLoading() {
        ...
        $BODY.animsition({
          ...
          loadingInner: '\n      <div class="loader-content"><div style="margin-bottom:1rem"><img class="navbar-brand-logo" src="'+assetPath+'images/logo@2x.png" title="" style="height: 70px;width:70px;"></div>\n        <div class="loader-index">\n          <div></div>\n          <div></div>\n          <div></div>\n          <div></div>\n          <div></div>\n          <div></div>\n        </div>\n      </div>',
          onLoadEvent: true
        });
      }
    }, {
