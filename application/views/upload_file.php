...
<form action="<?php echo base_url('task/upload/')?>" method="post" enctype="multipart/form-data">
	...
	<div class="container">
		...
		<input class="form-control inputbx" type="file" name="userfile" size="20"/>
	</div>
 ...
 -->	</div>
	...
	<div class="container">
		...
		<select class="form-select form-select-sm inputbx" aria-label="Team" name="team" id="team">
			...
			<option value="EA-NHDR">EA-NHDR</option>
...
<!-- 		<span style="color:red">* <?php echo @$categoryError;?></span>
 -->	</div>
	...
	<div class="container text-center" >
		<input class="btn btn-primary" type="submit" id="showtoast"><script type="text/javascript">toastr.success()</script></input>
