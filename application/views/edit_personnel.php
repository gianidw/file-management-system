...
?>
 ...
 <form action="<?php echo base_url('Task/processform')?>" method="post" enctype="multipart/form-data">
	...
	<div class="container">
		...
		<input class="inputbx" type="text" name="per_name" id="per_name" value="<?php echo @$tableData['dir_name']; ?>" autofocus>
	...
	<select class="form-select form-select-sm inputbx" name="sector" id="sector" style="margin-left; " value="<?php echo @$tableData['dir_position']; ?>" autofocus>><br>
	<option value="<?php echo @$tableData['dir_sector']; ?>" selected="selected"><?php echo @$tableData['dir_sector']; ?></option>
	<?php
...
?>
  ...
  <div class="form-group container">
    <div id="officeBox"><label >Office:</label>
        <select class="form-select form-select-sm inputbx" name="office" id="office" style="margin-left;">
            <option  value="<?php echo @$tableData['dir_office']; ?>"><?php echo @$tableData['dir_office']; ?></option>
    ...
    <div id="divisionBox"><label>Division:</label>
        <select class="form-select form-select-sm inputbx" name="division" id="division" style="margin-left;">
            <option  value="<?php echo @$tableData['dir_team']; ?>"><?php echo @$tableData['dir_team']; ?>Select Division</option>
        </select><span style="color:red">*<?php echo @$titleError;?></span>
    </div>
  </div>
  ...
  <br>
	...
	<div class="container">
		...
		<input class="inputbx" type="text" name="contact" id="contact" value="<?php echo @$tableData['dir_contact']; ?>" autofocus>
		<span style="color:red">* <?php echo @$titleError;?></span>
	</div>
	<br>
	<div class="container">
		<label for="title">Local No.</label>
		<input class="inputbx" type="text" name="local" id="local" value="<?php echo @$tableData['dir_local']; ?>" autofocus>
		<span style="color:red">* <?php echo @$titleError;?></span>
	</div>
	...
	<div class="container">
		...
		<button class="btn btn-secondary" type="button" onclick="javascript:window.location.href='<?php echo htmlspecialchars(base_url('home/directory'));?>'">Cancel</button>
	</div>
</form>
